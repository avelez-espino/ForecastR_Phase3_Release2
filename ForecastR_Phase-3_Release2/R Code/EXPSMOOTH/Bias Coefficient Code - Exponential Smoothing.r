##=========================================================================================
## Compute and visualize bias coefficient 
##
## Source: https://github.com/trnnick/TStools/blob/master/R/mre.R
##
##==========================================================================================

EXPSMOOTH$bias.coeff.updated <- function(mre,outplot=c(0,1,2)){
...
# Nikolaos Kourentzes, 2014 <nikolaos@kourentzes.com>
  ...
  if (outplot == 2){
    ...
    lines(c(0,0),c(0,2),col="lightblue",lwd=1.5, lty=2)
    text(0.5,1.5,'--')
    text(-0.5,1.5,'--')
    text(-0.5,1.5,"\n\n\nNegative bias \n (Over-forecasting)   ",cex=0.95)
    text(0.5,1.5,"\n\n\nPositive bias \n (Under-forecasting)  ",cex=0.95)
...
EXPSMOOTH$mre <- function(e,op=c("mean","sum","gm")){
...
EXPSMOOTH$plot.mre <- function(mre,main=NULL,plot.legend=c(TRUE,FALSE)){
