...
SIMPLELOGPOWER$barplot.forecasted.values.youngest.age.simplelogpower <- function(pred.int.individual.ages.avgfive.youngest,
                                                              pred.int.individual.ages.arima.youngest,
                                                              pred.int.individual.ages.expsmooth.youngest,
...
SIMPLELOGPOWER$barplot.forecasted.values.youngest.age.simplelogpower(SIMPLELOGPOWER$pred.int.individual.ages.avgfive.youngest,
...
SIMPLELOGPOWER$scatterplot.forecasted.values.and.forecast.intervals.youngest.age.simplelogpower.regression <- function(pred.int.individual.ages.avgfive.youngest,
                                                              pred.int.individual.ages.arima.youngest,
                                                              pred.int.individual.ages.expsmooth.youngest,
                                                              result.avgfive.youngest, result.arima.youngest, result.expsmooth.youngest,
                                                              forecastingyear, total.index, stockabundance){
...
SIMPLELOGPOWER$scatterplot.forecasted.values.and.forecast.intervals.youngest.age.simplelogpower.regression(
...
SIMPLELOGPOWER$barplot.forecasted.values.total.age.simplelogpower <- function(pred.int.individual.ages.avgfive.youngest,
                                                              pred.int.individual.ages.arima.youngest,
                                                              pred.int.individual.ages.expsmooth.youngest,
                                                              pred.int.total.age.simplelogpower.regression.all.models,
                                                              best.fits,
                                                              result.avgfive.youngest, result.arima.youngest, result.expsmooth.youngest,
                                                              forecastingyear, total.index, stockabundance){
        ...
        p <- SIMPLELOGPOWER$pred.int.total.age.simplelogpower.regression.all.models$p[[total.index]]   # point forecast for total age
...
SIMPLELOGPOWER$scatterplot.forecasted.values.and.forecast.intervals.total.age.simplelogpower.regression <- function(pred.int.individual.ages.avgfive.youngest,
                                                              pred.int.individual.ages.arima.youngest,
                                                              pred.int.individual.ages.expsmooth.youngest,
                                                              pred.int.total.age.simplelogpower.regression.all.models,
                                                              best.fits,
        ...
        p <- pred.int.total.age.simplelogpower.regression.all.models$p[[total.index]]   # point forecast for total age
       ...
       upper <- as.numeric(pred.int.total.age.simplelogpower.regression.all.models$p.upr[[total.index]])
       lower <- as.numeric(pred.int.total.age.simplelogpower.regression.all.models$p.lwr[[total.index]])
...
SIMPLELOGPOWER$retro.measures.all.ages.simplelogpower <- function(best.rmse.youngest.age){
...
SIMPLELOGPOWER$diagnostics.avgfive.model.fit.youngest.age  <- function(avgfive.model.fit.youngest){
...
SIMPLELOGPOWER$diagnostics.arima.model.fit.youngest.age  <- function(arima.model.fit.youngest){
...
SIMPLELOGPOWER$diagnostics.expsmooth.model.fit.youngest.age  <- function(expsmooth.model.fit.youngest){
...
SIMPLELOGPOWER$plot.yboot.simplelogpower.regression.youngest.age <- function(pred.int.individual.ages.avgfive.youngest,
                                                               pred.int.individual.ages.arima.youngest,
                                                               pred.int.individual.ages.expsmooth.youngest,
...
SIMPLELOGPOWER$plot.yboot.simplelogpower.regression.total.age <- function(pred.int.total.age.simple.sibling.regression.all.models,
                                                               total.index, stockabundance){
...
SIMPLELOGPOWER$plot.yboot.simplelogpower.regression.best.fitting.models <- function(best.fits, pred.int.individual.ages.simplelogpower.regression){
