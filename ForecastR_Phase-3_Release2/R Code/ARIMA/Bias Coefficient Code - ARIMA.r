...
ARIMA$bias.coeff.updated <- function(mre,outplot=c(0,1,2)){
...
ARIMA$mre <- function(e,op=c("mean","sum","gm")){
...
ARIMA$plot.mre <- function(mre,main=NULL,plot.legend=c(TRUE,FALSE)){
